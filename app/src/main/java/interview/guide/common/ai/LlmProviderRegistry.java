...
public class LlmProviderRegistry {
    ...
    private ChatClient createChatClient(String providerId) {
        ...
        // Spring AI 1.0 still requires an ObservationRegistry parameter here.
        // Using NOOP keeps the model wiring simple without enabling custom metrics collection.
    ...
    private List<Advisor> buildDefaultAdvisors(String providerId) {
        ...
        if (config.isToolCallEnabled()) {
            log.warn("[LlmProviderRegistry] Tool-call advisors are disabled for Spring AI 1.0 compatibility, provider={}",
                providerId);
        }
